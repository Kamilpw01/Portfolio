         ...
         <div className='intLeft'>
            <div className='intContainer'>
               ...
               <div className='intRow'>
                  ...
                  <button onClick={handleClick1} ><i className="fa-regular fa-plus"></i></button>
               </div>
               <hr />
               <div className='intRow'>
                  <div className='intSection'>Cyber Security</div>
                  <button onClick={handleClick2} ><i className="fa-regular fa-plus"></i></button>
               </div>
               <hr />
               <div className='intRow'>
                  <div className='intSection'>Web Design</div>
                  <button onClick={handleClick3} ><i className="fa-regular fa-plus"></i></button>
               </div>
               <hr />
               <div className='intRow'>
                  <div className='intSection'>Self-development</div>
                  <button onClick={handleClick4} ><i className="fa-regular fa-plus"></i></button>
               </div>
               <hr />
            </div>
